            ...
            <div className="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 lg:gap-8 mb-20 items-start relative z-10">
                    ...
                    <div className="lg:col-span-4 flex flex-col">
                        <Link href="/" className="mb-8 block -ml-4 relative">
                        ...
                        <p className="text-[#EFE7DF]/70 text-base leading-relaxed mb-8 max-w-sm font-medium">
                        ...
                        <div className="flex flex-wrap gap-4 mt-auto">
                            {/* Facebook */}
                            <a
                                className="w-11 h-11 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-[#EFE7DF] hover:bg-[#FF5400] hover:border-[#FF5400] hover:text-white transition-all duration-300 hover:shadow-lg hover:shadow-[#FF5400]/20 hover:-translate-y-1"
                    ...
                    <div className="lg:col-span-4 flex flex-col justify-between h-full">
                        ...
                        {/* Premium Space Filler Box */}
                        <div className="mt-10 lg:mt-0 relative overflow-hidden rounded-2xl bg-gradient-to-br from-[#1A1A1A] to-[#0a0a0a] border border-white/10 p-6 sm:p-8 backdrop-blur-md group hover:border-[#FF5400]/40 transition-colors duration-500">
